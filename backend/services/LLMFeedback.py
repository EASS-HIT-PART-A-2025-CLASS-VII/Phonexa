...
def analyze_pronunciation_with_llm(alignment_results):
    ...
    "   - For each mispronounced word identified, create a feedback string: `'Try saying <font color=\\'green\\'>{IPA_word}</font> instead of <font color=\\'red\\'>{user_phonemes}</font>'`\n"
    ...
    "   - ONLY highlight words identified in step 1 as `<font color='red'>word</font>`\n"
    ...
    "     \"try_saying\": [array of feedback strings created in step 2]\n"
    "   }\n"
    "   ```\n\n"
    "**Important:**\n"
